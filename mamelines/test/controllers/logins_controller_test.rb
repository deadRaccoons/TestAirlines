...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { activo: @login.activo, contraseña: @login.contraseña, correo: @login.correo }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { activo: @login.activo, contraseña: @login.contraseña, correo: @login.correo }
    assert_redirected_to login_path(assigns(:login))
  end
